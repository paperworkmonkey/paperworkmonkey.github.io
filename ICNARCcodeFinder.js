let data;
let searchTerm;
let searchTermBox, myResultsBox, myICNARCsystem, myICNARCsite, myICNARCprocess, myICNARCcondition, myICNARCcode;
...
function getSearchTerm() {
  ...
  let myRows = data.matchRows(searchTerm, "lowerCaseCondition");
  let SystemString = "";
  let SiteString = "";
  let ProcessString = "";
  let ConditionString = "";
